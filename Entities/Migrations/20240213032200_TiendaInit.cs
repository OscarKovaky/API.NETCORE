...
{
    public partial class TiendaInit : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RelacionesClienteArticulo", x => x.RelacionClienteArticuloId);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RelacionesClienteArticulo_AspNetUsers_ClienteId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RelacionesArticuloTienda", x => x.RelacionArticuloTiendaId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RelacionesArticuloTienda_ArticuloId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RelacionesClienteArticulo_ClienteId",
                table: "RelacionesClienteArticulo",
                column: "ClienteId");
        }
